...
_lr_productions = [
  ...
  ('expression -> LPAREN SAMPLE expression RPAREN','expression',4,'p_sample','parser.py',58),
  ('expression -> LPAREN OBSERVE expression expression RPAREN','expression',5,'p_observe','parser.py',62),
